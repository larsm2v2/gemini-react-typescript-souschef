...
const SousChef = () => {
   ...
   let preprompt:string = "You are a very skilled sous-chef and cooking teacher." + 
    ...
    return (
        <div className="souschef-prompt">
          ...
          <p className="typewriter2">
                ...and if you want to be more specific. Try the prompt sets below:
          </p>
